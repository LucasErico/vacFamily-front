...
const COR_OPTIONS = [
  { label: 'Verde (primário)', value: 'var(--color-primary)' },
  { label: 'Verde sucesso',    value: 'var(--color-success)' },
  { label: 'Laranja',          value: 'var(--color-warning)' },
  { label: 'Azul',             value: 'var(--color-blue)' },
  { label: 'Roxo',             value: 'var(--color-purple)' },
  { label: 'Vermelho',         value: 'var(--color-error)' },
]
...
const FORM_INICIAL: FormState = {
  titulo: '', descricao: '', cor: 'var(--color-primary)', icone: 'ShieldCheck', ativo: true,
}
...
export function AdminCardsPage() {
  ...
  const [editando, setEditando] = useState<string | null>(null) // id | 'novo' | null
