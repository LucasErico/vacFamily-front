/**
 * AdminShell
 * Layout base do painel admin com navegação atualizada (inclui Vacinas).
 */
import { useEffect } from 'react'
import { Outlet, useNavigate, NavLink } from 'react-router-dom'
import { LayoutDashboard, Users, Newspaper, Syringe, LogOut, ShieldCheck } from 'lucide-react'
...
export function AdminShell() {
  ...
  return (
    <div style={{
      ...
      <main style={{ padding: 'var(--space-8)', overflowY: 'auto', maxWidth: 900 }}>
        <Outlet />
      </main>
    </div>
  )
